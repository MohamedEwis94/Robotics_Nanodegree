...
#define VELOCITY_CONTROL false // #define VELOCITY_CONTROL true -for Objective 1
...
#define GAMMA 0.9f
#define EPS_START 0.8f //  #define EPS_START 0.9f -for Objective 1
#define EPS_END 0.01f // #define EPS_END 0.05f -for Objective 1
#define EPS_DECAY 300 // #define EPS_DECAY 200 -for Objective 1
...
#define LEARNING_RATE 0.15f // #define LEARNING_RATE 0.2f - Objective 1
#define REPLAY_MEMORY 10000
#define BATCH_SIZE 32// #define BATCH_SIZE 16 - Objective 1
...
bool ArmPlugin::updateAgent()
{
	...
	*/
	...
	/
	*/
	float joint = (action % 2 == 0) ? ref[action/2] + actionJointDelta : ref[action/2] - actionJointDelta; // TODO - Set joint position based on whether action is even or odd.
...
void ArmPlugin::OnUpdate(const common::UpdateInfo& updateInfo)
{
	...
	if( maxEpisodeLength > 0 && episodeFrames > maxEpisodeLength )
	{
		...
		rewardHistory = REWARD_LOSS * 20.0; // T#1 rewardHistory = REWARD_LOSS * 1000.0f;
		newReward     = true;
		endEpisode    = true;
	}
